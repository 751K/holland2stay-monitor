...
TRANSLATIONS = {
    ...
    # 地图筛选
    "map_filter_status":    {"zh": "状态",                    "en": "Status"},
    "map_filter_city":      {"zh": "城市",                    "en": "City"},
    "map_filter_source":    {"zh": "平台",                    "en": "Platform"},
    "map_filter_all":       {"zh": "全部",                    "en": "All"},
    "map_max_rent":         {"zh": "租金上限",                "en": "Max rent"},
    "map_min_area":         {"zh": "面积下限",                "en": "Min area"},
    "map_reset":            {"zh": "重置",                    "en": "Reset"},
    "map_showing":          {"zh": "显示",                    "en": "Showing"},
    "map_of":               {"zh": "／共",                    "en": "of"},
    "map_st_book":          {"zh": "可直订",                  "en": "Direct book"},
    "map_st_lottery":       {"zh": "摇号",                    "en": "Lottery"},
    "map_st_reserved":      {"zh": "已预留",                  "en": "Reserved"},
    ...
    "map_focus_out_of_view": {"zh": "这套房源不在当前地图范围内（已超出新鲜度窗口或被筛选条件排除），下面标出的是它的位置。",
                              "en": "This listing is outside the current map view (past the freshness window or excluded by filters). Its location is marked below."},
    "map_focus_no_coords":  {"zh": "这套房源的地址还没有解析出坐标，地图上没有它的位置。",
                              "en": "This listing's address has not been geocoded yet, so it has no position on the map."},
    "map_focus_not_found":  {"zh": "找不到这套房源，链接可能已经过期。",
                              "en": "This listing could not be found; the link may have expired."},
    "map_focus_dismiss":    {"zh": "知道了",                  "en": "Dismiss"},
    "view_on_map":          {"zh": "在地图上查看",            "en": "View on map"},
    ...
    # 这件事——账号要用户自己去办、自己付 €27,50/年。同理 en 用 "Auto-apply"
    # 而不是 "Auto-register"。
    "user_form_ab_plaza_on": {"zh": "开启 Plaza 自动申请",
                              "en": "Auto-apply on Plaza"},
